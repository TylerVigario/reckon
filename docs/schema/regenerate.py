...
c += [note("n5", "\"per site and per client. we talked about this. reoccurings should be "
                 ...
                 "(unlimited)\".\n\n"
                 "\"the default remote support is 2 hours\" — 9 Sep, but \"no default, "
                 "it should be set per agreement\" — 24 Sep. The pool is \"set at the "
                 "client level vs the site level\", so the meter sits here rather than "
                 "per location.\n\n"
